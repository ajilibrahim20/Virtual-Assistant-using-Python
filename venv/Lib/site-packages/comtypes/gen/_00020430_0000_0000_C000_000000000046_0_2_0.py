...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_PIXELS', 'OLE_XPOS_HIMETRIC', 'FONTNAME',
           'OLE_YPOS_CONTAINER', 'IFontEventsDisp', 'StdPicture',
           'Monochrome', 'OLE_HANDLE', 'OLE_YPOS_HIMETRIC',
           'OLE_CANCELBOOL', 'FONTUNDERSCORE', 'StdFont',
           'IPictureDisp', 'LoadPictureConstants', 'IFont',
           'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'Default', 'Unchecked', 'FONTBOLD',
           'VgaColor', 'FONTITALIC', 'Font', 'OLE_OPTEXCLUSIVE',
           'OLE_XPOS_PIXELS', 'OLE_ENABLEDEFAULTBOOL', 'Color',
           'OLE_XPOS_CONTAINER', 'Gray', 'OLE_TRISTATE',
           'OLE_XSIZE_CONTAINER', 'FONTSIZE', 'OLE_YPOS_PIXELS',
           'Picture', 'OLE_XSIZE_PIXELS', 'FontEvents',
           'FONTSTRIKETHROUGH', 'Checked', 'OLE_COLOR', 'IFontDisp',
           'IPicture']
